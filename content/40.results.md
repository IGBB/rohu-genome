...
estimated genome size. The annotation pipeline produced 51,079 primary
transcripts, 31,274 surviving the AED, gap, and overlapping filters. BUSCO
analysis show the genome completely contains 98.1% of the 3640 orthologs in the
actinopterygii_odb10 database with 37 (1%) duplicated; while, the filtered
transcriptome contains 84.5% of the total orthologs complete with 74 duplicated.
